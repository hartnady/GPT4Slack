...
def root_get():
    return 'Welcome to GPT Slack Bot. Please consult documentation for how to use this service.'
...
def slack_post_interactivity():
    ...
    if payload['type'] == 'view_submission':
        ...
        if INPUT_OPERATION == 'translate_en':
            ...
            pre_prompt = 'Acting as a Salesforce implementation consultant, consider the following text and draft a workshop agenda for it: '

        elif INPUT_OPERATION == 'risks':
            pre_prompt = 'Acting as a Delivery Director for a professional services company, provide a summary of potential risks found in the following text: '
...
def slack_slash_command_post():
    ...
    if text == 'debug':
        ...
        return latest_jobs #debug_results + latest_jobs
